...
Doctrine_Manager::getInstance()->bindComponent('____UBV_NOTAS', 'doctrine');
 ...
 * @method ____UBV_NOTAS setId()            Sets the current record's "id" value
 * @method ____UBV_NOTAS setIdAlumno()      Sets the current record's "id_alumno" value
 * @method ____UBV_NOTAS setIdMalla()       Sets the current record's "id_malla" value
 * @method ____UBV_NOTAS setIdUc()          Sets the current record's "id_uc" value
 * @method ____UBV_NOTAS setSeccion()       Sets the current record's "seccion" value
 * @method ____UBV_NOTAS setPeriodo()       Sets the current record's "periodo" value
 * @method ____UBV_NOTAS setNota()          Sets the current record's "nota" value
 * @method ____UBV_NOTAS setIdEstado()      Sets the current record's "id_estado" value
 * @method ____UBV_NOTAS setIdTipoAldea()   Sets the current record's "id_tipo_aldea" value
 * @method ____UBV_NOTAS setCertificaciï()  Sets the current record's "certificaciï" value
 * @method ____UBV_NOTAS setIdestado()      Sets the current record's "idestado" value
 * @method ____UBV_NOTAS setFecha()         Sets the current record's "fecha" value
 * @method ____UBV_NOTAS setAsignatura()    Sets the current record's "asignatura" value
 * 
 ...
 */
abstract class Base____UBV_NOTAS extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('______UBV_NOTAS');
