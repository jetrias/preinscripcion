...
Doctrine_Manager::getInstance()->bindComponent('NotasNacionales', 'doctrine');
 ...
 * @method NotasNacionales setId()            Sets the current record's "id" value
 * @method NotasNacionales setIdAlumno()      Sets the current record's "id_alumno" value
 * @method NotasNacionales setIdMalla()       Sets the current record's "id_malla" value
 * @method NotasNacionales setIdUc()          Sets the current record's "id_uc" value
 * @method NotasNacionales setSeccion()       Sets the current record's "seccion" value
 * @method NotasNacionales setPeriodo()       Sets the current record's "periodo" value
 * @method NotasNacionales setNota()          Sets the current record's "nota" value
 * @method NotasNacionales setIdEstado()      Sets the current record's "id_estado" value
 * @method NotasNacionales setIdTipoAldea()   Sets the current record's "id_tipo_aldea" value
 * @method NotasNacionales setCertificacion() Sets the current record's "certificacion" value
 * @method NotasNacionales setFecha()         Sets the current record's "fecha" value
 * @method NotasNacionales setAsignatura()    Sets the current record's "asignatura" value
 * 
 ...
 */
abstract class BaseNotasNacionales extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('notas_nacionales');
