...
/**
 * Notas9Coho filter form base class.
 *
 ...
 */
abstract class BaseNotas9CohoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('notas9_coho_filters[%s]');
