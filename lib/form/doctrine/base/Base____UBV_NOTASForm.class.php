...
/**
 * ____UBV_NOTAS form base class.
 *
 * @method ____UBV_NOTAS getObject() Returns the current form's model object
 *
 ...
 */
abstract class Base____UBV_NOTASForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('____ubv_notas[%s]');
