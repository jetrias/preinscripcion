...
/**
 * Electivos9 form base class.
 *
 * @method Electivos9 getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseElectivos9Form extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fecha_reg'     => new sfWidgetFormTextarea(),
      'hora_reg'      => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'fecha_reg'     => new sfValidatorString(array('required' => false)),
      'hora_reg'      => new sfValidatorString(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('electivos9[%s]');
