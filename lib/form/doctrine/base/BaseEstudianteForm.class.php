...
abstract class BaseEstudianteForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'estado_id'            => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Estado_10'), 'add_empty' => true)),
      'municipio_id'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Municipio_13'), 'add_empty' => true)),
      'parroquia_id'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Parroquia_15'), 'add_empty' => true)),
      ...
      'asic_id'              => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Asic_3'), 'add_empty' => true)),
      ...
      'codigo_tlf_id'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CodigoTlf_8'), 'add_empty' => true)),
      'codigo_tlf_casa_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CodigoTlf'), 'add_empty' => true)),
      'parentesco'           => new sfWidgetFormTextarea(),
      'codigo_tlf_contacto'  => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CodigoTlf_7'), 'add_empty' => true)),
      ...
      'asic_parroquia_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Parroquia'), 'add_empty' => true)),
      'asic_hab_id'          => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Asic'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'estado_id'            => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Estado_10'), 'required' => false)),
      'municipio_id'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Municipio_13'), 'required' => false)),
      'parroquia_id'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Parroquia_15'), 'required' => false)),
      ...
      'asic_id'              => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Asic_3'), 'required' => false)),
      ...
      'codigo_tlf_id'        => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CodigoTlf_8'), 'required' => false)),
      'codigo_tlf_casa_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CodigoTlf'), 'required' => false)),
      'parentesco'           => new sfValidatorString(array('required' => false)),
      'codigo_tlf_contacto'  => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CodigoTlf_7'), 'required' => false)),
      ...
      'asic_parroquia_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Parroquia'), 'required' => false)),
      'asic_hab_id'          => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Asic'), 'required' => false)),
