...
<th class="sf_admin_text sf_admin_list_th_identificacion ui-state-default ui-th-column">
  <?php if ('identificacion' == $sort[0]): ?>
    <?php /*echo link_to(__('Identificación', array(), 'messages'), '@preinscripcion?sort=identificacion&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'), array('class' => $sort[1]))*/ ?>
    ...
    <?php //echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php /*echo link_to(__('Identificación', array(), 'messages'), '@preinscripcion?sort=identificacion&sort_type=asc')*/ ?>
...
<?php end_slot(); ?>
<?php include_slot('sf_admin.current_header') ?><?php slot('sf_admin.current_header') ?>
<th class="sf_admin_text sf_admin_list_th_titulo_id ui-state-default ui-th-column">
  <?php if ('titulo_id' == $sort[0]): ?>
    <?php /*echo link_to(__('Titulo', array(), 'messages'), '@preinscripcion?sort=titulo_id&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'), array('class' => $sort[1]))*/ ?>

    <a href="<?php echo url_for('@preinscripcion?sort=titulo_id&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc')) ?>">
      <span class="ui-icon <?php echo ($sort[1] == 'asc' ? 'ui-icon-circle-triangle-s' : 'ui-icon-circle-triangle-n') ?>"></span>
      <?php echo __('Titulo', array(), 'messages') ?>
    </a>

    <?php //echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php /*echo link_to(__('Titulo', array(), 'messages'), '@preinscripcion?sort=titulo_id&sort_type=asc')*/ ?>
...
<th class="sf_admin_text sf_admin_list_th_uni_pre ui-state-default ui-th-column">
  <?php if ('uni_pre' == $sort[0]): ?>
    <?php /*echo link_to(__('Indique el nombre de la universidad donde cursó el Pregrado.', array(), 'messages'), '@preinscripcion?sort=uni_pre&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'), array('class' => $sort[1]))*/ ?>

    <a href="<?php echo url_for('@preinscripcion?sort=uni_pre&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc')) ?>">
      <span class="ui-icon <?php echo ($sort[1] == 'asc' ? 'ui-icon-circle-triangle-s' : 'ui-icon-circle-triangle-n') ?>"></span>
      <?php echo __('Indique el nombre de la universidad donde cursó el Pregrado.', array(), 'messages') ?>
    </a>

    <?php //echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php /*echo link_to(__('Indique el nombre de la universidad donde cursó el Pregrado.', array(), 'messages'), '@preinscripcion?sort=uni_pre&sort_type=asc')*/ ?>
...
<th class="sf_admin_text sf_admin_list_th_uni_mgi ui-state-default ui-th-column">
  <?php if ('uni_mgi' == $sort[0]): ?>
    <?php /*echo link_to(__('Indique el nombre de la universidad donde cursó el MGI.', array(), 'messages'), '@preinscripcion?sort=uni_mgi&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'), array('class' => $sort[1]))*/ ?>

    <a href="<?php echo url_for('@preinscripcion?sort=uni_mgi&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc')) ?>">
      <span class="ui-icon <?php echo ($sort[1] == 'asc' ? 'ui-icon-circle-triangle-s' : 'ui-icon-circle-triangle-n') ?>"></span>
      <?php echo __('Indique el nombre de la universidad donde cursó el MGI.', array(), 'messages') ?>
    </a>

    <?php //echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php /*echo link_to(__('Indique el nombre de la universidad donde cursó el MGI.', array(), 'messages'), '@preinscripcion?sort=uni_mgi&sort_type=asc')*/ ?>
...
<th class="sf_admin_foreignkey sf_admin_list_th_pnfa_id ui-state-default ui-th-column">
  <?php if ('pnfa_id' == $sort[0]): ?>
    <?php /*echo link_to(__('Seleccione el PNFA que aspira', array(), 'messages'), '@preinscripcion?sort=pnfa_id&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'), array('class' => $sort[1]))*/ ?>

    <a href="<?php echo url_for('@preinscripcion?sort=pnfa_id&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc')) ?>">
      <span class="ui-icon <?php echo ($sort[1] == 'asc' ? 'ui-icon-circle-triangle-s' : 'ui-icon-circle-triangle-n') ?>"></span>
      <?php echo __('Seleccione el PNFA que aspira', array(), 'messages') ?>
    </a>

    <?php //echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php /*echo link_to(__('Seleccione el PNFA que aspira', array(), 'messages'), '@preinscripcion?sort=pnfa_id&sort_type=asc')*/ ?>
